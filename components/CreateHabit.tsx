...
export default function CreateHabit({ children }: { children: ReactElement }) {
    ...
    return (
        <>
            ...
            }} className=' w-12 h-12 text-2xl text-gray-700 flex justify-center border items-center my-auto border-gray-400 rounded-full bg-gray-100 hover:bg-gray-200'>+</button>
