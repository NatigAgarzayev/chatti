...
export default function KanbanBoard({ loading, dropId, innerItems }: { loading?: boolean, dropId: string, innerItems: any[] }) {
    return (
        ...
        >
            {
                (provided: any) => (
                    <div className={`${loading && "animate-pulse"} bg-gray-100 dark:bg-gray-800 h-full p-4 rounded-3xl overflow-hidden overflow-y-scroll`} ref={provided.innerRef} {...provided.droppableProps}>
                        {
