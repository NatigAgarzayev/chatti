    ...
    return (
        <div className='w-full h-screen p-4 bg-white rounded-l-3xl dark:bg-gray-900 dark:rounded-none'>
            <h2 className='flex h-12 items-center gap-4 ml-6 text-xl text-gray-900 dark:text-gray-300'>
                <p>{habitsAll.length === (user.publicMetadata.paid ? 15 : 5) ? 'You have reached the maximum amount of habits. Chatti Pro is required to create 15.' : habitsAll.length === 0 ? 'You have no habits.' : 'Create a new habit'}</p>
                {
